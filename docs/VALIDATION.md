...
| CSV | Création et mise à jour, UTF-8, séparateur alternatif, guillemets, erreurs multiples, doublons, chevauchements, absence d’import partiel, refus de changement de CIDR avec IP attribuées ; jeu de démonstration importable validé : 6 sites, 48 VLAN, 2 775 IP et 6 préfixes différents ; export contextuel par GUID même avec VID identique sur un autre site |
