...
| Vue VLAN Headless | Logo/icône, actions textuelles contextuelles, masque, bascule 2 → 1022 lignes, virtualisation et défilement jusqu’à la dernière IP, prochaine libre, CSV/historique contextuels ; détails dépliables, logo 96 px, champs sans texte indicatif, conservation du focus de recherche |
| Disposition compacte | Colonnes d’accueil adaptatives avec largeur minimale cible de 440 px, maximum local configurable de 1 à 6 (3 par défaut), 6 colonnes possibles sur très grande largeur ; cartes d’une même ligne de hauteur égale et actions site ancrées en bas. À 1320 × 850, début de liste avant 300 px et hauteur utile supérieure à 500 px ; à 760 × 540, hauteur supérieure à 180 px et bouton d’ajout visible |
