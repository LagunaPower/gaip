...
| Cache | Synchronisation entre sessions, hors ligne en lecture seule, redémarrage sur cache, corruption réparée en ligne/refusée hors ligne, autre partage refusé ; restauration d’un gaip-data.json partagé manquant depuis le cache validé, sans écrasement possible d’une base existante |
