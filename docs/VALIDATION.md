...
| Historique VLAN | Journal de différences champ par champ, événements du VLAN et de ses IP, libération, changement de VID, exclusion des événements étrangers, filtrage direct par ID avant limite de 1000 ; test avec une base de ~1 Mo : une modification légère produit une ligne d’historique inférieure à 4 Kio |
