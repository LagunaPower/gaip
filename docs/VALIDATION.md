...
| Modèle | Passerelle, IP hors réseau, chevauchement inter-sites, unicités, VID, réservations, champs multilignes, casse, absence de cascade, CIDR figé dès qu’une IP est attribuée avec passerelle seule explicitement exclue ; multicast 224.0.0.0/4, unicité groupe/port et références IP/VLAN valides |
