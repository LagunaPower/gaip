...
- **Multicast** : un groupe est identifié par son adresse IPv4 multicast, avec nom et description. Chaque groupe contient des flux identifiés par leur port UDP, avec contenu, description, zéro ou plusieurs IP sources déjà attribuées dans G@IP et zéro ou plusieurs VLAN associés. Un groupe non vide ne peut pas être supprimé.
