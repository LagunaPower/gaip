...
Application desktop C# / .NET 10 / Avalonia 12.1 pour gérer sites, VLAN, adressage IPv4 et multicast. Sans SQL, serveur, inventaire matériel ou compte applicatif. Windows x64 et Linux x64 ; Wayland natif prioritaire, repli XWayland explicite. G@IP est un logiciel open source distribué sous licence MIT.
...
À chaque tag strict `vMAJOR.MINOR.PATCH`, les tests et tous les artefacts Windows/Linux sont d’abord construits et vérifiés. Le RPM est installé réellement sous AlmaLinux 8 en CI. La Release GitHub n’est créée en brouillon puis rendue publique qu’après réussite complète de ces étapes. Elle publie les archives portables standard et trimmed, ainsi qu’un **MSI Windows x64**, un **DEB amd64** et un **RPM x86_64**. Les trois paquets installables sont construits à partir de la variante trimmed ; les archives standard restent disponibles comme solution de repli.
